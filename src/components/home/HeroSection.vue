<template>
  ...
  <section class="relative overflow-hidden home-page">
     <!-- Оптимизированное фоновое изображение --> <picture class="hero-background"
      >
      <source
        srcset="
    ...
    <div class="w-full backdrop-blur-xs bg-secondary/50 dark:bg-background/75 relative z-10">
      ...
      <div class="app-container py-24 sm:py-16 md:py-20 lg:py-32 h-full">
...
const { elementRef: statsRef } = createRevealRef()
</script>
